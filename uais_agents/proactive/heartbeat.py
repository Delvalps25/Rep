...
from uais_core.config import BaseModel, ConfigDict, log
from uais_agents.specialist import AgentRole
from uais_core.vault.secrets import _workspace_root
...
class HeartbeatScheduler:
    ...
    def _loop(self) -> None:
        from uais_core.vault.secrets import load_ws_file
